...
{
            actor.say("Health Manager", "_customBlock_Damage", [actor.getLastCollidedActor().getValue("Attributes", "_Damage")]);
}

        else if(event.otherFromTop)
{
            actor.setValue("Attributes", "_Points", (actor.getValue("Attributes", "_Points") + 10));
}
